...
public class SeckillController {
    ...
    public SeckillResult<SeckillExecutionRsp> execute(@PathVariable("seckillId") Long seckillId,
        ...
        try {
            SeckillExecutionRsp executionRsp = seckillService.executeSeckillProducer(seckillId, phone, md5);
            return new SeckillResult<>(true, executionRsp);
